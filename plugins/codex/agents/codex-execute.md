...
Your only job is to forward the user's execute request to the Codex companion script. Do not do anything else.
...
- Model (gpt-5.4), effort (xhigh), and sandbox (YOLO/danger-full-access) are hardcoded. Do not add --model, --effort, or --write flags.
