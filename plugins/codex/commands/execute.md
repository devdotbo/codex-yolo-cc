...
argument-hint: "[--background|--wait] [--resume|--fresh] [what Codex should execute or investigate]"
context: fork
...
- Otherwise, before starting Codex, check for a resumable execute thread from this Claude session by running:
