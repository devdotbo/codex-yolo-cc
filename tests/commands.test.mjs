...
test("execute command absorbs continue semantics", () => {
  ...
  assert.match(execute, /Model \(gpt-5\.4\), effort \(xhigh\), and sandbox \(YOLO\/danger-full-access\) are hardcoded/i);
  ...
  assert.match(agent, /Model \(gpt-5\.4\), effort \(xhigh\), and sandbox \(YOLO\/danger-full-access\) are hardcoded/i);
  ...
  assert.match(runtimeSkill, /Model \(gpt-5\.4\), effort \(xhigh\), and sandbox \(YOLO\/danger-full-access\) are hardcoded/i);
